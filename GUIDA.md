...
| Nessun profilo nella cartella | Non e' piu' un errore: il layout viene **dedotto** dalla cartella stessa (fonts nella radice, oppure una cartella per categoria, oppure categorie dentro un contenitore) e l'app te lo dice nel riquadro *Layout guessed*. Il bottone *Write slotify.profile.json* mette per iscritto la deduzione, che e' anche il posto dove poi vivranno palette e range di codepoint |
